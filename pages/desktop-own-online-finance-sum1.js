...
import BookingSummaryWrapper from "../components/booking-summary-wrapper";
import QuoteForm from "../components/quote-form";
import Footer from "../components/footer";
import Header from "../components/header";
import { useEffect } from "react";

const DesktopOwnOnlineFinanceSum11 = () => {
  useEffect(() => {
    ...
    <div className="max-w-[1366px] mx-auto">
      <div className="relative bg-colors-dark-background w-full h-[1704px] overflow-hidden text-left text-xs text-colors-primary-white font-p1-web-regular">
        ...
        <img
          ...
          alt=""
          src="/illustrationfireworks1.svg"
        />
        ...
        <Footer propJustifyContent="center" />
        <Header
...
export default DesktopOwnOnlineFinanceSum11;
