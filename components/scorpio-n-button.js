...
const ScorpioNButton = ({
  ...
  const vehicleCardStyle = useMemo(() => {
    return {
      width: propWidth,
  ...
  return (
    <div className="flex flex-row items-start justify-start gap-[20px] text-left text-lg text-colors-primary-white font-p1-web-regular">
      <div
        className="rounded-3xs bg-colors-dark-container-dark w-[388px] flex flex-col p-5 box-border items-center justify-start gap-[18px]"
